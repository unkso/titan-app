  ...
  return deepmerge(
    {
      ...
      h1: createElementStyles(FONT_WEIGHT_REGULAR, 1.4, 1.8, TEXT_CASE_CAPITALIZE),
      h2: createElementStyles(FONT_WEIGHT_REGULAR, 1.3, 1.6, TEXT_CASE_CAPITALIZE),
      ...
      small: createElementStyles(FONT_WEIGHT_REGULAR, 1, 0.8, TEXT_CASE_REGULAR)
    },
    typography
  );
}
